...
struct Triangle
{
    ...
    Triangle();
    Triangle(const vec3& p0, const vec3& p1, const vec3& p2, const vec3& t0 = vec3(0.0f, 0.0f, 0.0f), const vec3& t1 = vec3(0.0f, 0.0f, 0.0f), const vec3& t2 = vec3(0.0f, 0.0f, 0.0f), const Material* mat = nullptr);
